...
describe('GET /exams/discipline', () => {
    ...
    it('Erro no token deve retornar 401', async () => {
        ...
        const result = await supertest(app).get("/exams/discipline").send().set('Authorization', `Bear ${text}`);
        const status = result.status;

        const result2 = await supertest(app).get("/exams/discipline").send();
        const status2 = result2.status;

        const result3 = await supertest(app).get("/exams/discipline").send().set('Authorization', `Bearer ${text + 123}`);;
        const status3 = result3.status;
...
describe('GET /exams/teacher', () => {
    ...
    it('Sucesso deve retornar 200', async () => {
        ...
        const result = await supertest(app).get("/exams/teacher").send().set('Authorization', `Bearer ${text}`);
        const status = result.status;
    ...
    it('Erro no token deve retornar 401', async () => {
        ...
        const result = await supertest(app).get("/exams/teacher").send().set('Authorization', `Bear ${text}`);
        const status = result.status;

        const result2 = await supertest(app).get("/exams/teacher").send();
        const status2 = result2.status;

        const result3 = await supertest(app).get("/exams/teacher").send().set('Authorization', `Bearer ${text + 123}`);;
        const status3 = result3.status;
